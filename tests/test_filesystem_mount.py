...
'''
        ...
        response = execute_python_code(http_session, base_url, code, timeout=90)  # Longer timeout for plot creation
...
'''
        ...
        response = execute_python_code(http_session, base_url, code, timeout=120)  # Extended timeout
