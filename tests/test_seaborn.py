...
plt.savefig('/mnt/plots/direct_save_regression.png', dpi=150, bbox_inches='tight')
plt.close()

# Verify the file was created
import os
file_exists = os.path.exists('/mnt/plots/direct_save_regression.png')
file_size = os.path.getsize('/mnt/plots/direct_save_regression.png') if file_exists else 0
...
# Save directly to the mounted filesystem
plt.savefig('/mnt/plots/direct_save_dashboard.png', dpi=150, bbox_inches='tight')
plt.close()
...
# Verify the file was created
import os
file_exists = os.path.exists('/mnt/plots/direct_save_dashboard.png')
file_size = os.path.getsize('/mnt/plots/direct_save_dashboard.png') if file_exists else 0
