...
class TestErrorHandlingCodeExecution:
    ...
    def test_given_empty_code_when_executing_then_validation_error_returned(
        ...
        response = requests.post(
            f"{base_url}/api/execute-raw", json=payload, timeout=api_timeout
        )
    ...
    def test_given_invalid_code_type_when_executing_then_validation_error_returned(
        self, server, base_url, api_timeout
    ):
        """
        ...
        assert any(
            ...
            for keyword in ["code", "provided", "body", "invalid"]
        )

    def test_given_python_syntax_error_when_executing_then_syntax_error_returned(
        self, server, base_url, api_timeout
    ):
        """
        ...
        assert any(
            keyword in response_text
            for keyword in ["syntax", "expected", "invalid syntax", "error"]
        )

    def test_given_python_runtime_error_when_executing_then_runtime_error_returned(
        self, server, base_url, api_timeout
    ):
        """
        ...
        response_text = response.text.lower()
        assert (
            "division" in response_text
            or "zerodivision" in response_text
    ...
    def test_given_invalid_timeout_when_executing_then_validation_error_returned(
        ...
        response = requests.post(
            f"{base_url}/api/execute-raw", json=payload, timeout=10
        )
        ...
        assert any(
            keyword in response_text
            for keyword in ["timeout", "invalid", "code", "provided", "body"]
        )

    def test_given_excessive_timeout_when_executing_then_validation_error_returned(
        self, server, base_url
    ):
        """
        ...
        payload = {
            "code": "print('test')",
            "timeout": 400000,
        }  # 400 seconds, likely exceeds limit
...
class TestErrorHandlingPackageInstallation:
    ...
    def test_given_empty_package_name_when_installing_then_validation_error_returned(
        self, server, base_url, api_timeout
    ):
        """
        ...
        response = requests.post(
            f"{base_url}/api/install-package", json=payload, timeout=api_timeout
        )
    ...
    def test_given_missing_package_field_when_installing_then_validation_error_returned(
        self, server, base_url, api_timeout
    ):
        """
    ...
    def test_given_invalid_package_type_when_installing_then_validation_error_returned(
        self, server, base_url, api_timeout
    ):
        """
    ...
    def test_given_invalid_package_name_when_installing_then_validation_error_returned(
        self, server, base_url, api_timeout
    ):
        """
    ...
    def test_given_blocked_package_when_installing_then_forbidden_error_returned(
        self, server, base_url, api_timeout
    ):
        """
    ...
    def test_given_nonexistent_package_when_installing_then_not_found_error_returned(
        self, server, base_url, api_timeout
    ):
        """
        ...
        assert (
            "Can't fetch metadata for 'nonexistent-package-xyz123'"
            in response_data.get("error", "")
        )
...
class TestErrorHandlingFileOperations:
    ...
    def test_given_no_file_when_uploading_then_validation_error_returned(
        self, server, base_url, api_timeout
    ):
        """
    ...
    def test_given_invalid_file_type_when_uploading_then_validation_error_returned(
        self, server, base_url, api_timeout
    ):
        """
    ...
    def test_given_oversized_file_when_uploading_then_size_limit_error_returned(
        self, server, base_url
    ):
        """
    ...
    def test_given_nonexistent_uploaded_file_when_deleting_then_not_found_error_returned(
        self, server, base_url, api_timeout
    ):
        """
        ...
        response = requests.delete(
            f"{base_url}/api/uploaded-files/nonexistent.csv", timeout=api_timeout
        )
    ...
    def test_given_path_traversal_attempt_when_deleting_then_security_error_returned(
        self, server, base_url, api_timeout
    ):
        """
        ...
        response = requests.delete(
            f"{base_url}/api/uploaded-files/../../../etc/passwd", timeout=api_timeout
        )
...
class TestErrorHandlingAPIEndpoints:
    ...
    def test_given_nonexistent_endpoint_when_requesting_then_not_found_error_returned(
        self, server, base_url, api_timeout
    ):
        """
    ...
    def test_given_wrong_http_method_when_requesting_then_method_not_allowed_error_returned(
        self, server, base_url
    ):
        """
    ...
    def test_given_malformed_json_when_posting_then_json_parse_error_returned(
        self, server, base_url
    ):
        """
    ...
    def test_given_invalid_content_type_when_posting_then_content_type_error_returned(
        self, server, base_url
    ):
        """
    ...
    def test_given_extremely_large_payload_when_posting_then_payload_size_error_returned(
        self, server, base_url
    ):
        """
        ...
        response = requests.post(
            f"{base_url}/api/execute-raw", json=payload, timeout=30
        )
